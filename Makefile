...
NAME = uProcessor
#Project Schematics
SCHEMATICS = uProcessor.sch microphones.sch interface.sch debug.sch power.sch switches.sch cableconnectors.sch hidden-magic.sch isostimbreakout.sch headbreakout.sch headboard-i2s.sch headboard-analog.sch cpubreak.sch power-alt.sch
#Project Netlists
NETLISTS = $(NAME).net
